...
public class LoginOtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, phoneNumber + " is here.", Toast.LENGTH_SHORT).show();
                ...
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(LoginOtpActivity.this, "OTP verification failed2.", Toast.LENGTH_SHORT).show();
                                setInProgress(false);
                            }
        ...
        mAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(LoginOtpActivity.this, "OTP verification failed1", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
